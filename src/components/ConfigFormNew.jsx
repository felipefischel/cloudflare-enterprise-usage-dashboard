    ...
    applicationServices: {
      ...
      core: {
        ...
        thresholdBandwidth: initialConfig?.thresholdBandwidth 
          ? (initialConfig.thresholdBandwidth / (1024 ** 4)) 
          : (initialConfig?.applicationServices?.core?.thresholdBandwidth ? (initialConfig.applicationServices.core.thresholdBandwidth / (1024 ** 4)) : ''),
      ...
      const config = {
        ...
        applicationServices: {
          core: {
            ...
            thresholdBandwidth: formData.applicationServices.core.thresholdBandwidth ? Math.round(parseFloat(formData.applicationServices.core.thresholdBandwidth) * (1024 ** 4)) : null,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            {appServices.botManagement.enabled && (
              <div className="space-y-4 mt-4 pt-4 border-t border-gray-300">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Contracted Good Requests (Millions)
                  </label>
                  <input
                    type="number"
                    ...
                    step="0.01"
                  />
                  <p className="text-xs text-gray-500 mt-1">Total contracted good requests across all selected zones</p>
                </div>
